...
//// test all variations.
//func makeSMTProvers(mt *Trie) []func(key []byte) *memorydb.Database {
...
//		}
//		val, err := trie.VerifyProof(common.BytesToHash(mt.Root().Bytes()), keyBytes, proof)
//		if err != nil {
...
//			}
//			val, err := trie.VerifyProof(common.BytesToHash(root.Bytes()), kv.k, proof)
//			if err != nil {
...
//
//			if _, err := trie.VerifyProof(common.BytesToHash(root.Bytes()), kv.k, proof); err == nil {
...
//}
//
//func randomZktrie(t *testing.T, n int) (*Trie, map[string]*kv) {
